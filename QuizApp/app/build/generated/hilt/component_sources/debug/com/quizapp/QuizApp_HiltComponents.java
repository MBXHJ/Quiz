...
import com.quizapp.di.RepositoryModule;
...
public final class QuizApp_HiltComponents {
  private QuizApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements QuizApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          BankListViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          BankListViewModel_HiltModules.BindsModule.class,
